...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'glass': '0 4px 24px -4px rgba(0,0,0,0.12), 0 1px 4px -1px rgba(0,0,0,0.08)',
        'glass-dark': '0 4px 24px -4px rgba(0,0,0,0.5), 0 1px 4px -1px rgba(0,0,0,0.3)',
        'glow': '0 0 20px -5px rgba(6,182,212,0.35)',
        'glow-sm': '0 0 10px -3px rgba(6,182,212,0.25)',
      },
      animation: {
